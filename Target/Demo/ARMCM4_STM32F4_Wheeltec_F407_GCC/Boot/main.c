...
#define BOOT_UART_CLK_ENABLE       __HAL_RCC_USART1_CLK_ENABLE
#define BOOT_UART_CLK_DISABLE      __HAL_RCC_USART1_CLK_DISABLE
#define BOOT_UART_GPIO_AF          GPIO_AF7_USART1
#ifndef BOOT_RS232_USART1_PINSET
#define BOOT_RS232_USART1_PINSET   (0)
#endif
#if (BOOT_RS232_USART1_PINSET == 0)
#define BOOT_UART_GPIO_PORT        GPIOA
#define BOOT_UART_GPIO_CLK_ENABLE  __HAL_RCC_GPIOA_CLK_ENABLE
#define BOOT_UART_GPIO_CLK_DISABLE __HAL_RCC_GPIOA_CLK_DISABLE
#define BOOT_UART_GPIO_PINS        (GPIO_PIN_9 | GPIO_PIN_10)
#elif (BOOT_RS232_USART1_PINSET == 1)
#define BOOT_UART_GPIO_PORT        GPIOB
#define BOOT_UART_GPIO_CLK_ENABLE  __HAL_RCC_GPIOB_CLK_ENABLE
#define BOOT_UART_GPIO_CLK_DISABLE __HAL_RCC_GPIOB_CLK_DISABLE
#define BOOT_UART_GPIO_PINS        (GPIO_PIN_6 | GPIO_PIN_7)
#else
#error "Unsupported BOOT_RS232_USART1_PINSET value."
#endif
#elif (BOOT_COM_RS232_CHANNEL_INDEX == 1)
#define BOOT_UART_CLK_ENABLE       __HAL_RCC_USART2_CLK_ENABLE
#define BOOT_UART_CLK_DISABLE      __HAL_RCC_USART2_CLK_DISABLE
#define BOOT_UART_GPIO_AF          GPIO_AF7_USART2
...
#define BOOT_UART_GPIO_CLK_ENABLE  __HAL_RCC_GPIOA_CLK_ENABLE
#define BOOT_UART_GPIO_CLK_DISABLE __HAL_RCC_GPIOA_CLK_DISABLE
#define BOOT_UART_GPIO_PINS        (GPIO_PIN_2 | GPIO_PIN_3)
#elif (BOOT_RS232_USART2_PINSET == 1)
#define BOOT_UART_GPIO_PORT        GPIOD
#define BOOT_UART_GPIO_CLK_ENABLE  __HAL_RCC_GPIOD_CLK_ENABLE
#define BOOT_UART_GPIO_CLK_DISABLE __HAL_RCC_GPIOD_CLK_DISABLE
#define BOOT_UART_GPIO_PINS        (GPIO_PIN_5 | GPIO_PIN_6)
#else
#error "Unsupported BOOT_RS232_USART2_PINSET value."
#endif
#elif (BOOT_COM_RS232_CHANNEL_INDEX == 2)
#define BOOT_UART_CLK_ENABLE       __HAL_RCC_USART3_CLK_ENABLE
#define BOOT_UART_CLK_DISABLE      __HAL_RCC_USART3_CLK_DISABLE
#define BOOT_UART_GPIO_AF          GPIO_AF7_USART3
...
#define BOOT_UART_GPIO_CLK_ENABLE  __HAL_RCC_GPIOB_CLK_ENABLE
#define BOOT_UART_GPIO_CLK_DISABLE __HAL_RCC_GPIOB_CLK_DISABLE
#define BOOT_UART_GPIO_PINS        (GPIO_PIN_10 | GPIO_PIN_11)
#elif (BOOT_RS232_USART3_PINSET == 1)
#define BOOT_UART_GPIO_PORT        GPIOC
#define BOOT_UART_GPIO_CLK_ENABLE  __HAL_RCC_GPIOC_CLK_ENABLE
#define BOOT_UART_GPIO_CLK_DISABLE __HAL_RCC_GPIOC_CLK_DISABLE
#define BOOT_UART_GPIO_PINS        (GPIO_PIN_10 | GPIO_PIN_11)
#elif (BOOT_RS232_USART3_PINSET == 2)
#define BOOT_UART_GPIO_PORT        GPIOD
#define BOOT_UART_GPIO_CLK_ENABLE  __HAL_RCC_GPIOD_CLK_ENABLE
#define BOOT_UART_GPIO_CLK_DISABLE __HAL_RCC_GPIOD_CLK_DISABLE
#define BOOT_UART_GPIO_PINS        (GPIO_PIN_8 | GPIO_PIN_9)
#else
#error "Unsupported BOOT_RS232_USART3_PINSET value."
#endif
#elif (BOOT_COM_RS232_CHANNEL_INDEX == 3)
#define BOOT_UART_CLK_ENABLE       __HAL_RCC_UART4_CLK_ENABLE
#define BOOT_UART_CLK_DISABLE      __HAL_RCC_UART4_CLK_DISABLE
#define BOOT_UART_GPIO_AF          GPIO_AF8_UART4
...
#define BOOT_UART_GPIO_CLK_ENABLE  __HAL_RCC_GPIOA_CLK_ENABLE
#define BOOT_UART_GPIO_CLK_DISABLE __HAL_RCC_GPIOA_CLK_DISABLE
#define BOOT_UART_GPIO_PINS        (GPIO_PIN_0 | GPIO_PIN_1)
...
#define BOOT_UART_GPIO_PORT_TX     GPIOC
#define BOOT_UART_GPIO_PORT_RX     GPIOD
#define BOOT_UART_GPIO_CLK_ENABLE_TX __HAL_RCC_GPIOC_CLK_ENABLE
#define BOOT_UART_GPIO_CLK_ENABLE_RX __HAL_RCC_GPIOD_CLK_ENABLE
#define BOOT_UART_GPIO_CLK_DISABLE_TX __HAL_RCC_GPIOC_CLK_DISABLE
#define BOOT_UART_GPIO_CLK_DISABLE_RX __HAL_RCC_GPIOD_CLK_DISABLE
#define BOOT_UART_CLK_ENABLE       __HAL_RCC_UART5_CLK_ENABLE
#define BOOT_UART_CLK_DISABLE      __HAL_RCC_UART5_CLK_DISABLE
#define BOOT_UART_GPIO_PIN_TX      GPIO_PIN_12
#define BOOT_UART_GPIO_PIN_RX      GPIO_PIN_2
#define BOOT_UART_GPIO_AF          GPIO_AF8_UART5
#elif (BOOT_COM_RS232_CHANNEL_INDEX == 5)
#define BOOT_UART_CLK_ENABLE       __HAL_RCC_USART6_CLK_ENABLE
#define BOOT_UART_CLK_DISABLE      __HAL_RCC_USART6_CLK_DISABLE
#define BOOT_UART_GPIO_AF          GPIO_AF8_USART6
...
#define BOOT_UART_GPIO_PORT        GPIOG
#define BOOT_UART_GPIO_CLK_ENABLE  __HAL_RCC_GPIOG_CLK_ENABLE
#define BOOT_UART_GPIO_CLK_DISABLE __HAL_RCC_GPIOG_CLK_DISABLE
#define BOOT_UART_GPIO_PINS        (GPIO_PIN_9 | GPIO_PIN_14)
#else
...
void HAL_MspInit(void)
{
  ...
  /* Configure GPIO pin for (optional) backdoor entry input. The board's TS key
   * pulls PE0 low when pressed.
   */
  ...
  BOOT_UART_GPIO_CLK_ENABLE_TX();
  BOOT_UART_GPIO_CLK_ENABLE_RX();
  GPIO_InitStruct.Pin = BOOT_UART_GPIO_PIN_TX;
  GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  GPIO_InitStruct.Alternate = BOOT_UART_GPIO_AF;
  HAL_GPIO_Init(BOOT_UART_GPIO_PORT_TX, &GPIO_InitStruct);
  GPIO_InitStruct.Pin = BOOT_UART_GPIO_PIN_RX;
  HAL_GPIO_Init(BOOT_UART_GPIO_PORT_RX, &GPIO_InitStruct);
#else
  BOOT_UART_GPIO_CLK_ENABLE();
  GPIO_InitStruct.Pin = BOOT_UART_GPIO_PINS;
  GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  GPIO_InitStruct.Alternate = BOOT_UART_GPIO_AF;
  HAL_GPIO_Init(BOOT_UART_GPIO_PORT, &GPIO_InitStruct);
#endif
#endif
...
void HAL_MspDeInit(void)
{
  ...
  /* Deinit used GPIOs. */
#if (BOOT_COM_RS232_CHANNEL_INDEX == 4)
  HAL_GPIO_DeInit(BOOT_UART_GPIO_PORT_TX, BOOT_UART_GPIO_PIN_TX);
  HAL_GPIO_DeInit(BOOT_UART_GPIO_PORT_RX, BOOT_UART_GPIO_PIN_RX);
  BOOT_UART_GPIO_CLK_DISABLE_TX();
  BOOT_UART_GPIO_CLK_DISABLE_RX();
#else
  HAL_GPIO_DeInit(BOOT_UART_GPIO_PORT, BOOT_UART_GPIO_PINS);
  BOOT_UART_GPIO_CLK_DISABLE();
#endif
  /* UART clock disable. */
  BOOT_UART_CLK_DISABLE();
#endif
